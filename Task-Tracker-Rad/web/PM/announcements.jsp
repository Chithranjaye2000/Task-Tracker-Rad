...
<html>
    <head>
        ...
        <title>Announcements</title> <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-1ycn6IcaQQ40/MKBW2W4Rhis/DbILU74C1vSrLJxCq57o941Ym01SwNsOMqvEBFlcgUa6xLiPY/NS5R+E6ztJQ==" crossorigin="anonymous" referrerpolicy="no-referrer"/>
    </head>
    <body>
        ...
        <div class="container">
            ...
            %>
            <div class="mt-3">
                <form method="POST" action="announcement-process.jsp">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        <textarea class="form-control" id="msj" name="msj" required></textarea>
                    </div> 

                    <input class="mt-5 w-25 btn btn-primary" type="submit" value="Announce" >
