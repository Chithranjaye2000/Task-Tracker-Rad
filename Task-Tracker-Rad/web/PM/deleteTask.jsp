        ...
        <div class="container">
            ...
            <%
                if (request.getParameter("delete") != null) {
                    ...
                    if (delete.equals("1")) {
                        message = "<div class='alert alert-success' role='alert'>Task Deleted Successfully.</div>";
                    } else if (delete.equals("2")) {
                        message = "<div class='alert alert-danger' role='alert'>Task Deletion Failed.</div>";
                    }
                    out.println(message);
                }
            %>
            <div>
                <form method="POST" action="deleteTask-Process.jsp">
                    <div class="row">
                        <div class="col-lg-10">
                        ...
                        <div class="col-lg-2">
                            <input class="btn btn-danger d-block w-100" type="submit" value="Delete Task" />
                        </div>
                    </div>
                </form>
            </div>
